...
# --- [관리자 설정: 좌표 및 안내문구 수정 영역] ---
# 알려주신 35.5416, 129.2555 좌표를 첫 번째 구역에 적용했습니다.
AREAS = [
    {
        "name": "화학물 저장소 (A구역)",
        "lat": 35.5416,  # 보내주신 위도 적용
        "lon": 129.2555, # 보내주신 경도 적용
        "info": "방독면 착용 필수 및 화기 엄금! 내부 진입 시 관리자 승인 요망."
    },
    {
        "name": "제조 라인 (B구역)",
        "lat": 35.5678,  # 다른 구역이 추가되면 여기에 위도를 넣으세요
        "lon": 129.5678, # 다른 구역이 추가되면 여기에 경도를 넣으세요
...
if loc:
    ...
    found = False
    for area in AREAS:
        # 내 위치와 설정된 위치가 약 50m~100m 이내면 인식 (0.0008 도 차이)
